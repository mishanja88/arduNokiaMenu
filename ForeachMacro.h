#ifndef FOREACH_MACRO_H
#define FOREACH_MACRO_H

// Make a FOREACH macro
// author: Marvin ( http://stackoverflow.com/posts/11994395/ )
...
#define FE_30(WHAT, X, ...) WHAT(X)FE_39(WHAT, __VA_ARGS__)
